...
| -------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🧠 **Transformer from Scratch**                                                        | Implementasi arsitektur Transformer dari nol (Scaled Dot-Product & Multi-Head Attention, Positional Encoding, Encoder-Decoder) berdasarkan paper _Attention Is All You Need_. |
| ⚙️ **[Workflow-CI](https://github.com/alfdmsr/Workflow-CI)**                           | Pipeline CI/CD untuk model _predictive maintenance_ — training otomatis, tracking dengan MLflow, build & push image ke Docker Hub via GitHub Actions.                         |
